...
} from "@/stores/slices/api/doctor.slices.api";
...
const Doctor = () => {
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between">
          <span className="text-default-400 text-small">
            Tổng có : {doctorResponse?.data?.count || "đang xử lý"}
          </span>
  ...
  const renderCell = useCallback((user, columnKey) => {
    ...
    switch (columnKey) {
      ...
      case "exp":
        return (
          <p className="capitalize text-bold text-small">{`${cellValue} năm`}</p>
        );
      case "price":
        return (
      ...
      case "updated_at":
        return (
          <p className="capitalize text-bold text-small">
            {moment(cellValue).utc().format("DD/MM/YYYY HH:mm:ss")}
          </p>
        );
      case "actions":
        return (
          <div className="relative flex items-center justify-end gap-2">
            <Dropdown>
              ...
              <DropdownMenu>
                ...
                <DropdownItem onClick={() => handleDeleteDoctor(user)}>
                  Xóa
                </DropdownItem>
              </DropdownMenu>
            </Dropdown>
              ...
              >
                ...
                <ModalBody>
                  <div className="grid grid-cols-2 gap-4">
                    <div
                      {...getRootProps()}
                      className="col-span-2 flex items-center justify-center border-dashed border-2 border-gray-400 p-4 text-center m-h-[100px] rounded"
                    >
                      ...
                      <Input
                        {...register("exp", {
                          ...
                          pattern: {
                            value: /^[0-9]+$/,
                            message:
                              "Số năm kinh nghiệm không hợp lệ, chỉ chứa số",
                          },
                          min: {
                            value: 0,
                            message:
                          ...
                          max: {
                            value: 50,
                            message:
                              "Số năm kinh nghiệm phải nhỏ hơn hoặc bằng 50",
                          },
                        })}
                        isDisabled={type === "view"}
                        label="Kinh nghiệm"
                    ...
                    <div>
                      <Select
                        {...register("doctor_group_id", {
                          required: "Nhóm bác sĩ không được rỗng",
                        })}
